...
echo -e "\E[34m                               |_|                            "
echo "                                                                       "
echo -e "\E[34m          By UnknowUser50 || version 1.1.3 || 2020            "
echo "                                                                       "
echo "                                                                       "
echo "                                                                       "
...
echo -e "\E[34m {1011}-- Others connexion                           \E[0m       "
echo -e "\E[34m {1100}-- Manual/Documentation                       \E[0m       "
echo -e "\E[34m                                                     \E[0m       "
...
then
	...
	then
		...
		echo -e "\E[31m [+] Leaving Octopus ... please wait ... \E[0m"
		sleep 2 
		exit
...
then
	...
	clear
		...
		echo -e "\E[34m {10}-- Lunch aircrack-ng                            \E[0m"
		echo "                                                               "
		...
		then
			...
			then
				...
				echo -e -n "\E[36m [+] Enter your network interface : \E[0m"
				read interface
				aircrack-ng start $interface 
				sleep 2
				echo -e -n "\E[36m [+] Now, enter the name with 'mon' at the end : \E[0m"
				read monitor
				aircrack-ng start $monitor 
				sleep 1
				echo -e "\E[34m [+] Start of WIFI scan ... \E[0m"
				sleep 1
				airodump-ng $monitor
				sleep 1 
...
then
	...
	echo -e "\E[34m {16}-- Use basic SQL injection                        \E[0m"
	echo "                                                       "
	echo -e "\E[34m {99}-- Leave Octopus                                  \E[0m"
	echo "                                                       "
	echo -e "\E[34m ##################################################### \E[0m"
	...
	then
		...
		echo -e "\E[34m [+] For the moment, it ts a test module, it will be improved later ... \E[0m"
		sleep 1 
		echo -e -n "\E[36m [+] Enter the URL of the target : \E[0m"
		read target
		sleep 1 
		sudo sqlmap --$target --dbs && sudo sqlmap --$target >> sql-results.txt
		sleep 1
...
then
	...
	echo -e "\E[34m                                  _                   "
	echo -e "\E[34m                                 (_)                  "
	echo -e "\E[34m   ___ ___  _ __  _ __   _____  ___  ___  _ __        "
	echo -e "\E[34m  / __/ _ \| '_ \| '_ \ / _ \ \/ / |/ _ \| '_ \       "
	echo -e "\E[34m | (_| (_) | | | | | | |  __/>  <| | (_) | | | |      "
	echo -e "\E[34m  \___\___/|_| |_|_| |_|\___/_/\_\_|\___/|_| |_|      "
	echo -e "\E[34m                                                      "
	echo -e "\E[34m #################################################### "       
	echo -e "\E[34m [+] SSH AND NETCAT TEST FOR NEXT UG"
	echo -e "\E[34m #################################################### "
	echo " "
	echo -e "\E[34m {0}-- SSH connexion \E[0m"
	echo -e "\E[34m {1}-- Netcat connexion \E[0m"
	echo " "
	echo -e "\E[34m {9}-- Leave Octopus "
	echo "" 
	...
	then
		...
		echo -e "\E[34m [+] Starting SSH protocol on port 22 ... please wait ..."
		sleep 2
		echo -e -n "\E[34m [+] Choose the username : \E[0m"
		read username
		echo -e -n "\E[34m [+] Choose the IP address : \E[0m"
		read ip_net
		echo -e "\E[34m [+] Starting connexion on $username@$ip_net \E[0m"
		sudo ssh $username@$ip_net
		sleep 2
		echo -e "\E[34m [+] Thanks to uses Octopus ... BYE ... \E[0m"
	...
	then
		...
		echo -e "\E[34m [+] Starting Netcat ... please wait ... "
		sleep 2 
		echo -e -n "\E[34m [+] Enter the destination port : \E[0m"
		read port 
		echo -e -n "\E[34m [+] Enter the IP address : \E[0m"
		read ip
		echo -e -n "\E[31m [+] Do you want to add an arguments ? (1/2) : \E[0m"
		read arg

		if [ $arg = $Non ]
		then
			# Start without argument
			echo -e  "\E[34m [+] Start Netcat on $ip on port $port ... "
			sleep 2
			sudo nc -nv $ip $port
			echo -e "\E[34m [+] Thanks to uses Octopus ... BYE ..."
			exit
		...
		then
			...
			# Start with argument
			echo -e -n "\E[34m [+] Enter your argument :\E[0m"
			read argument
			echo -e "\E[34m [+] Stating Netcat on port $port and IP $ip with '$argument' ... \E[0m"
	...
	then
		...
		echo -e "\E[31m [+] Choose one or press CTRL+C ..."
		sleep 1
	fi	
